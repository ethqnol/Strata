...
struct Lasso[
    ...
    def __init__(
        ...
        Raises:
            InvalidParameterError: If alpha < 0, max_iter <= 0, or tol < 0.
        """
        check_floating_dtype[Self.compute_dtype, "Lasso"]()
        if alpha < 0:
    ...
    def __init__(out self, *, copy: Self):
        """Copies an existing Lasso instance."""
    ...
    def predict[
        ...
        """
        check_is_fitted("Lasso", self.is_fitted)
